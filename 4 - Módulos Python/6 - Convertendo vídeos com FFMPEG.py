...
"""
Trabalhando com conversores de vídeo

ffmpeg -i "ENTRADA" -i "LEGENDA" -c:v libx264 -crf 23 -preset ultrafast -c:a aac -b:a 320k 
-c:s srt -map: v:0 a -map 1:0 -SSA 00:00:00 -TO 00:00:10 "SAÍDA"
...
caminho_origem = r'C:\Users\user\Desktop\Teste para curso python\videos'
caminho_destino = r'C:\Users\user\Desktop\Teste para curso python\pasta vazia'
